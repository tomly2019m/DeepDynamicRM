...
class UploadMedia_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        ...
                        self.media_types.append(_elem5)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.req_id is not None:
            oprot.writeFieldBegin('req_id', TType.I32, 1)
            oprot.writeI32(self.req_id)
            oprot.writeFieldEnd()
        if self.media_types is not None:
            ...
            for iter12 in self.media_types:
        ...
        if self.medium is not None:
            ...
            for iter13 in self.medium:
                oprot.writeString(iter13.encode('utf-8') if sys.version_info[0] == 2 else iter13)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.carrier is not None:
            oprot.writeFieldBegin('carrier', TType.STRING, 4)
